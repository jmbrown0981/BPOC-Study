...
"______" means a firearm or anything manifestly designed, made, or adapted for the purpose of inflicting death or serious bodily injury, or anything that in the manner of its use or intended use is capable of causing death or serious bodily injury.

**Explanation:** PC 1.07(a)(17) defines "deadly weapon" this way — the definition that triggers the drug-offense enhancements in PC 12.35(c)(1).
...
- [x] A deadly weapon was used or exhibited during the commission of the offense, or during immediate flight from it
- [ ] The offense occurred in a school zone
- [ ] The amount of the controlled substance exceeded four grams

**Explanation:** PC 12.35(c)(1) elevates a state-jail-felony drug offense to third-degree-felony punishment when a deadly weapon (as defined by PC 1.07) was used or exhibited during the offense or immediate flight from it.
...
Under Government Code 508.145(d), an inmate whose judgment contains an affirmative deadly-weapon finding is not eligible for parole until actual calendar time served equals ______ of the sentence (or 30 calendar years, whichever is less) — versus the default one-fourth rule under 508.145(f) for inmates without such a finding.

**Explanation:** Gov't Code 508.145(d) sets the deadly-weapon-finding parole floor at one-half of the sentence (min. 2 years, capped at 30 calendar years); 508.145(f) sets the general default at one-fourth of the sentence or 15 years, whichever is less.
...
- [x] The inmate must serve at least half the sentence before parole eligibility, instead of the general one-fourth minimum
- [ ] The inmate becomes permanently ineligible for parole
- [ ] The inmate's sentence is automatically doubled
- [ ] It has no effect on parole eligibility, only on the trial-level offense grade

**Explanation:** Gov't Code 508.145(d) requires an inmate with a qualifying deadly-weapon finding to serve at least one-half of the sentence (or 30 years, whichever is less) before parole eligibility, rather than the general one-fourth minimum under 508.145(f).
...
- [ ] The defendant becomes eligible for deferred adjudication regardless of the amount involved
- [ ] The offense is automatically reduced to a state jail felony
- [x] The punishments specified by 481.112(b) and (c) are increased by one degree, and the minimum terms/fines under 481.112(e) and (f) are increased
- [ ] Only a fine enhancement applies; the term of imprisonment is unaffected

**Explanation:** HSC 481.1122 increases PG1 manufacturing punishments by one degree, and raises the 481.112(e)/(f) minimum terms and maximum fines, when a child under 18 was present on the premises during the offense.
...
Under HSC 481.1285, a registrant or dispenser who knowingly diverts a controlled substance to the unlawful use or benefit of another person (rather than converting it to their own use) commits a felony of the ______ degree.

**Explanation:** HSC 481.1285(c) splits the diversion offense: converting the substance to the person's own use/benefit under (b)(1) is a state jail felony, while diverting it to another person's unlawful use/benefit under (b)(2) is a third-degree felony.
...
- [ ] A first offense versus a repeat offense
- [x] Converting the substance to the person's own use/benefit (state jail felony) versus diverting it to another's unlawful use/benefit (third-degree felony)
- [ ] Possessing the substance versus manufacturing the substance
- [ ] Diversion by a pharmacist versus diversion by a physician, with identical penalties for both

**Explanation:** 481.1285(b)(1)-(2) and (c) draw this distinction — self-conversion is a state jail felony, while diverting to someone else's unlawful use is a third-degree felony.
...
- [ ] The person was merely present in the same household as someone who has a prior drug conviction
- [ ] The person possessed any legally prescribed medication in the home
- [x] The person injected, ingested, inhaled, or otherwise introduced a Penalty Group 1 or 1-B controlled substance into the human body while not in lawful possession of it
- [ ] The person was arrested for an unrelated traffic offense with a child in the vehicle

**Explanation:** PC 22.041(c-1)(3) creates this presumption specifically for unlawful introduction of a PG1 or PG1-B substance into the human body — one of three presumption triggers listed in (c-1), alongside manufacturing/possessing methamphetamine or PG1-B near the victim, and a positive toxicology result tied to proximity/accessibility.
...
- [x] A first-degree felony punishable by life or 25-99 years
- [ ] A third-degree felony, same as the underlying PG1-B offense

**Explanation:** PC 71.023(a)(3) covers offenses punishable under HSC 481.1123(d), (e), or (f) — the higher PG1-B weight tiers — among other qualifying offenses; PC 71.023(b) makes directing such activity a first-degree felony punishable by life or 25-99 years, regardless of the underlying offense's own punishment level.
...
- [ ] Directing criminal street gang or foreign terrorist organization drug activities
- [ ] Manufacture of a Penalty Group 1 substance in the presence of a child
- [x] A mandatory doubling of any fine for a second offense

**Explanation:** BPOC 15.4 lists deadly weapon findings, presence-of-child PG1 manufacture, complex/synthetic PG2-A enhancements, diversion by registrants/dispensers, child endangerment via CS introduction, and gang/terrorist-organization direction — a blanket fine-doubling rule is not among them.
...
- [ ] Only a district court judge, with no agency discretion permitted
- [x] A court (under 481.159), or the department/a criminal justice agency/a peace officer (under department rules or 481.161)
- [ ] The property must always be destroyed within 24 hours regardless of any court order
- [ ] Only the Texas Department of Public Safety director personally

**Explanation:** HSC 481.153(b) allows a court to order disposition under 481.159, or lets the department, a criminal justice agency, or a peace officer summarily destroy the property under department rules, or dispose of it in lieu of destruction under 481.161.
...
- [ ] Destruction only by court order, with no administrative rule permitted
- [ ] Notarization of the destroyed property's estimated street value
- [x] More than one person to witness the destruction, an inventory of what's destroyed, and a statement naming the witnesses and details of the destruction
- [ ] A minimum 90-day waiting period after seizure before any destruction

**Explanation:** HSC 481.154(b) requires multiple witnesses, an inventory, and a documented statement of who witnessed the destruction and how it was carried out.
...
- [ ] The property owner has provided written consent to the destruction
- [ ] A jury has already returned a verdict in the related criminal case
- [x] At least five random representative samples are taken and preserved, photographs are taken depicting the total amount, and the gross weight/measure is determined
...
"______" means a device or a drug that is unsafe for self-medication and that is not included in Schedules I through V or Penalty Groups 1 through 4 of Chapter 481 (Texas Controlled Substances Act), including one bearing a legend such as "Caution: federal law prohibits dispensing without prescription" or "Rx only."

**Explanation:** HSC 483.001(2) defines "dangerous drug" by exclusion from the Controlled Substances Act's schedules/penalty groups, plus the federal prescription-required legend requirement.
...
**Explanation:** This is the definitional line between Chapter 481 controlled substances and Chapter 483 dangerous drugs — a dangerous drug is specifically NOT a scheduled/penalty-group substance.
...
"______" means to sell, dispense, give away, or supply in any other manner, as defined for purposes of the Texas Dangerous Drug Act.

**Explanation:** HSC 483.001(3) defines "deliver" broadly — this is the dangerous-drug-chapter counterpart to the similarly broad "deliver or offer to deliver" definition under HSC 481.002 for controlled substances.
...
- [ ] Only a sale for monetary consideration
- [x] To sell, dispense, give away, or supply in any other manner
- [ ] To physically inject or administer the drug to a patient
- [ ] To transport the drug across a county line

**Explanation:** 483.001(3) defines "deliver" broadly to cover selling, dispensing, giving away, or supplying a dangerous drug in any other manner.
...
"______" means a person, other than a pharmacist, who manufactures dangerous drugs, including a person who prepares dangerous drugs in dosage form by mixing, compounding, encapsulating, entableting, or any other process.

**Explanation:** HSC 483.001(6) specifically excludes pharmacists from this definition — a pharmacist who compounds a drug for dispensing is practicing pharmacy, not "manufacturing" under this chapter.
...
- [ ] A notarized signature from the patient
- [x] The date of issue, the patient's name and address, and the name and quantity of the drug prescribed
- [ ] The wholesale cost of the drug
- [ ] The patient's Social Security number

**Explanation:** 483.001(13) lists required prescription elements including issue date, patient name/address, drug name/quantity, directions for use, and the practitioner's printed/stamped name, address, and phone number.
...
- [ ] Hallucinations only, with no analgesic effect
- [ ] Muscle growth and increased strength
- [ ] Increased heart rate and alertness with no risk of physical dependence
- [x] Pain relief and euphoria, with a high risk of respiratory depression and overdose

**Explanation:** Narcotics/opioids are central-nervous-system depressants used medically for pain relief; their euphoric effect and risk of respiratory depression/overdose make them commonly abused per BPOC 15.7.
...
______ (such as cocaine and methamphetamine) speed up the body's systems, producing increased energy, alertness, and euphoria, but carry risks including elevated heart rate, paranoia, and cardiac events.

**Explanation:** BPOC 15.7 lists stimulants as one of the three major commonly-abused-drug categories, alongside narcotics/opioids and depressants.
...
**Explanation:** Cocaine and methamphetamine are stimulants — they speed up the central nervous system, unlike narcotics/opioids or depressants, which slow it down.
...
- [ ] Producing hallucinations with no sedative effect
- [ ] Having no effect on the central nervous system
- [ ] Increasing heart rate and blood pressure
- [x] Slowing down brain activity, producing sedation, relaxation, and (at high doses) respiratory depression

**Explanation:** Depressants slow central-nervous-system activity, producing sedation and relaxation, with respiratory depression risk at high doses or when combined with other CNS depressants (including opioids or alcohol).
...
The ______ drug category is the one most closely associated with the current overdose epidemic, largely due to synthetic substances like fentanyl.

**Explanation:** BPOC 15.7 identifies narcotics/opioids (including synthetic opioids such as fentanyl) as the category driving the overdose crisis discussed in the chapter.
...
**Explanation:** BPOC 15.7's three categories are narcotics/opioids, stimulants, and depressants.
...
**Explanation:** BPOC 15.8 groups paraphernalia by method of use — needles/syringes fall under Injection.
...
Small plastic bags and balloons used to hold powdered or gaseous substances for huffing/snorting are examples of paraphernalia associated with the ______ method of drug use.

**Explanation:** BPOC 15.8 lists bags and balloons as Inhalation-method paraphernalia.
...
**Explanation:** BPOC 15.8 categorizes gelatin capsules and tablets under Ingestion-method paraphernalia.
...
Transdermal patches, drops, foam, and gel containers are examples of paraphernalia associated with the ______ method of drug use.

**Explanation:** BPOC 15.8 lists patches, drops, foam, and gel containers under the Application method.
...
- [ ] Transdermal patches — Ingestion
- [ ] Gelatin capsules — Injection
- [x] Balloons — Inhalation
- [ ] Needles — Application

**Explanation:** The correct BPOC 15.8 pairings are: needles/syringes-Injection, bags/balloons-Inhalation, gelatin capsules/tablets-Ingestion, patches/drops/foam/gel containers-Application.
...
- [ ] The manufacturer of the paraphernalia
- [x] The method of drug use (injection, inhalation, ingestion, application)
- [ ] Whether the item is legal to possess
- [ ] The drug's penalty group classification

**Explanation:** BPOC 15.8 groups paraphernalia examples by method of use: Injection, Inhalation, Ingestion, and Application.
...
- [ ] A state jail felony
- [x] A Class A misdemeanor

**Explanation:** HSC 483.041(d) classifies possession of a dangerous drug as a Class A misdemeanor.
...
- [ ] Possession of any quantity under one ounce
- [ ] Possession that occurs outside of Texas
- [ ] Possession by anyone under 18 years of age, regardless of source
- [x] Possession by a wholesaler, manufacturer, pharmacist, or practitioner in the lawful course of business or practice

**Explanation:** 483.041(c) exempts, among others, possession by a manufacturer, wholesaler, pharmacist, or practitioner acting in the lawful course of business, and possession under a valid prescription or order.
...
- [x] A state jail felony
- [ ] A Class B misdemeanor

**Explanation:** HSC 483.042 classifies delivering or offering to deliver a dangerous drug as a state jail felony, higher than simple possession under 483.041.
...
- [ ] Always a first-degree felony regardless of prior record
- [ ] A Class C misdemeanor with no enhancement possible
...
- [ ] No exceptions whatsoever, under any circumstance
- [ ] An exception only if the pharmacist is also the prescriber
- [x] Specific disaster-related exception provisions allowing limited emergency refills
- [ ] An exception only for controlled substances, not dangerous drugs

**Explanation:** HSC 483.047(b), (b-1), and (b-2) carve out limited disaster-related exceptions permitting refills without prior authorization under specified emergency conditions.
...
- [ ] Decline to accept a personal check as payment
- [ ] File taxes late
- [ ] Advertise a dangerous drug's price
- [x] Refuse to permit an authorized inspection of premises, records, or stock of dangerous drugs

**Explanation:** HSC 483.050 makes it an offense to refuse a lawful inspection under the Texas Dangerous Drug Act.
...
"______" means the dried flowers of the plant Cannabis sativa L. and any derivative, extract, oil, or other substance obtained from that plant that contains not more than 1 percent by weight of tetrahydrocannabinols, prescribed under the Texas Compassionate-Use Program.

**Explanation:** Occupations Code 169.001 defines "low-THC cannabis" as the substance authorized under the Compassionate-Use Program, capped at not more than 1 percent THC by weight (note: not to be confused with the 0.3 percent delta-9 THC hemp threshold under Agriculture Code 121.001).
...
**Explanation:** "Low-THC cannabis" is the Occupations Code term specific to the medical Compassionate-Use Program; "hemp" is the separate Agriculture Code term for industrial/consumer hemp capped at 0.3% delta-9 THC.
...
- [x] Be a qualified, board-certified physician specializing in the treatment of the patient's qualifying condition and be registered with the compassionate-use registry
- [ ] Obtain a separate DEA controlled-substance registration number
- [ ] Be employed directly by the Department of Public Safety
- [ ] Simply hold any active Texas medical license, with no specialty or registry requirement

**Explanation:** Occupations Code 169.002 requires the prescribing physician to be qualified/board-certified in treating the patient's condition and registered with the compassionate-use registry maintained under 169.004.
...
Under Occupations Code 169.003, a low-THC cannabis prescription for a qualifying Texas resident may be written for up to a ______ supply, with a maximum of four refills.

**Explanation:** Occupations Code 169.003 caps low-THC cannabis prescriptions at a 90-day supply with up to four refills, for Texas residents with a qualifying condition such as epilepsy, multiple sclerosis, cancer, autism, PTSD, or certain chronic-pain conditions.
...
- [ ] Only the patients themselves, with no physician information recorded
- [ ] Only dispensing organizations, with no prescriber information recorded
- [ ] Only law enforcement agencies for tracking purposes
- [x] Prescribing physicians, so pharmacies can verify a prescription's validity, while keeping physician identities confidential as required

**Explanation:** Occ. Code 169.004 has DPS maintain the secure compassionate-use registry of registered prescribing physicians, with confidentiality protections for physician identity as specified.
...
- [x] The patient's diagnosis, the physician's treatment rationale, and periodic evaluation of the patient's response to treatment
- [ ] Only the dispensing pharmacy's inventory records
- [ ] The patient's employer and occupation
- [ ] Only the patient's name and date of birth

**Explanation:** Occ. Code 169.005 requires the physician to maintain a treatment plan documenting diagnosis, rationale, and ongoing evaluation of the patient's response.
...
- [ ] Home cultivation of marijuana plants for personal medical use
- [x] Prescription of low-THC cannabis by registered, qualified physicians to patients with specified qualifying conditions
- [ ] Unrestricted recreational marijuana use for adults 21 and older
- [ ] Possession of any amount of marijuana without a prescription

**Explanation:** BPOC 15.10 covers Occupations Code Chapter 169's narrow medical program — it authorizes physician-prescribed low-THC cannabis for qualifying patients, not general marijuana legalization.
...
"______" means the plant Cannabis sativa L., whether growing or not, the seeds of that plant, and every compound, manufacture, salt, derivative, mixture, or preparation of that plant or its seeds, subject to specified exceptions including hemp, as that term is defined by Section 121.001, Agriculture Code.

**Explanation:** HSC 481.002(26) defines "marihuana" and, in subsection (26)(F), expressly excludes hemp (as defined by Agriculture Code 121.001) from that definition — the dividing line is the plant's delta-9 THC concentration.
...
- [ ] Hemp must contain 0% THC to be legal
- [ ] There is no THC-based distinction — the distinction is based solely on plant color
- [x] Hemp contains not more than 0.3% delta-9 THC by dry weight; anything above that concentration is marijuana
- [ ] Hemp contains not more than 5% delta-9 THC; anything above that is marijuana

**Explanation:** Agriculture Code 121.001 caps hemp at not more than 0.3 percent delta-9 THC by dry weight; Cannabis sativa L. exceeding that concentration falls under HSC 481.002(26)'s marihuana definition instead.
...
Because hemp and marijuana are visually and by-smell indistinguishable, HSC 481.159(c)(1) requires a ______ analysis (lab testing for delta-9 THC concentration) to legally establish that a plant sample is marijuana rather than hemp.

**Explanation:** HSC 481.159(c)(1) requires a qualified individual to conduct a quantitative analysis of the substance — this is the testing standard that resolves the marijuana/hemp distinction under 481.002(26)(F) and Ag. Code 121.001.
...
- [ ] Its intent to defer entirely to federal DEA regulation of hemp
- [ ] Its intent to ban all hemp production statewide
- [x] Its intent to maintain primary regulatory authority over the production of hemp in the state
- [ ] Its intent to treat hemp identically to marijuana for all legal purposes

**Explanation:** Ag. Code 121.002 states the legislature's intent for Texas to maintain primary regulatory authority over hemp production within the state.
...
- [ ] Set the statewide marijuana penalty-group thresholds
- [ ] Issue federal DEA registration numbers to hemp growers
- [x] Prepare and submit a state hemp production plan (consistent with 7 U.S.C. 1639p) coordinated with HSC Chapter 443
- [ ] Approve or deny compassionate-use registry applications

**Explanation:** Ag. Code 121.003 requires TDA to submit a state plan under the federal hemp-production framework (7 U.S.C. 1639p), coordinated with HSC Chapter 443 (the state's hemp-program regulatory chapter).
...
- [ ] Reclassify hemp as a Penalty Group 1 controlled substance
- [ ] Issue medical marijuana prescriptions directly to patients
- [x] Adopt rules necessary to implement and administer the state's hemp program
- [ ] Set federal hemp policy for all fifty states

**Explanation:** Ag. Code 121.004 gives TDA rulemaking authority to implement Chapter 121's hemp-production framework.
...
- [ ] May destroy the plant on scene without documentation
- [ ] May charge marijuana possession based on appearance and odor alone with no legal risk
- [ ] Should assume it is hemp and take no enforcement action under any circumstance
- [x] Cannot conclusively establish, for prosecution purposes, whether the plant is illegal marijuana or legal hemp

**Explanation:** Because HSC 481.002(26)(F) turns entirely on THC concentration, and marijuana/hemp are indistinguishable by sight or smell, prosecutable marijuana cases generally require the quantitative lab analysis called for in HSC 481.159(c)(1).
...
- [ ] The arresting officer's personal judgment based on appearance alone
- [ ] A pharmacy technician at a retail pharmacy
- [x] The Texas Department of Public Safety crime laboratory system, or a certified/accredited local agency laboratory
- [ ] An online drug-identification database with no lab confirmation

**Explanation:** BPOC 15.12 identifies DPS crime labs and certified/accredited local agency labs as the entities that perform legally definitive substance identification.
...
In the field, an officer may use a presumptive ______ to develop probable cause, but such a preliminary test does not substitute for laboratory confirmation before prosecution.

**Explanation:** BPOC 15.12's instructor note references field test kits as a presumptive, probable-cause-level tool — distinct from the DPS/certified-lab quantitative analysis needed for prosecution.
...
- [x] The Physicians' Desk Reference (PDR) and resources such as Drugs.com
- [ ] Only word-of-mouth from other officers
- [ ] Only the vehicle's registration records
- [ ] Only the Texas Penal Code's definitions section

**Explanation:** The instructor note lists the PDR and online resources like Drugs.com as references officers can use to help identify pills/substances encountered in the field.
...
- [x] The risk of exposure to unknown or highly potent substances (e.g., fentanyl) during handling or field testing
- [ ] The risk of damaging the field test kit's packaging
- [ ] The risk of violating chain-of-custody rules only, with no physical safety concern
- [ ] The risk of a defamation lawsuit from the substance's owner

**Explanation:** Instructors are directed to discuss officer-safety issues tied to handling unknown substances in the field, given the risk of exposure to highly potent substances.
...
- [x] Dangerous drugs seized in connection with a Chapter 483 violation
- [ ] Only vehicles used to transport dangerous drugs
- [ ] Only cash proceeds from dangerous drug sales
- [ ] Only firearms seized incident to a drug arrest

**Explanation:** HSC 483.074 governs seizure and destruction of dangerous drug property itself, mirroring the Chapter 481 framework but under the Texas Dangerous Drug Act.
...
- [x] Dangerous drugs under Chapter 483 are a legally distinct category from Chapter 481 controlled substances, so they're governed by the Dangerous Drug Act's own procedures
- [ ] Because Chapter 483 only applies to substances seized outside Texas
- [ ] Because dangerous drugs cannot legally be destroyed under any circumstance
- [ ] Because 483.074 was repealed and 481.153 now applies to both

**Explanation:** HSC 483.001(2) defines "dangerous drug" specifically as a substance NOT covered by Chapter 481's schedules/penalty groups — so Chapter 483 maintains its own parallel seizure/destruction framework.
...
- [ ] A vehicle with obvious, visible modifications advertising its purpose
- [ ] The newest, most expensive vehicle available, to impress buyers
- [ ] Always a rental vehicle registered in the driver's own name
- [x] A reliable, inconspicuous vehicle unlikely to draw attention or break down during a long haul

**Explanation:** BPOC 15.14 identifies reliability and inconspicuousness as the key traits traffickers look for in a load vehicle.
...
A common load-car characteristic officers are trained to look for is the presence of ______ — hidden voids built into the vehicle to conceal contraband, often revealed by mismatched trim or tampered fasteners.

**Explanation:** BPOC 15.14 lists false/hidden compartments, along with mismatched trim panels and tampered lug nuts or screws, as physical indicators of a modified load vehicle.
...
- [ ] Current vehicle registration and insurance matching the driver
- [ ] A clean, unmodified factory interior with no aftermarket parts
- [ ] A single occupant with no luggage of any kind
- [x] Mismatched trim panels or tampered lug nuts/screws suggesting recent disassembly

**Explanation:** BPOC 15.14 flags mismatched trim and tampered fasteners (lug nuts, screws) as signs the vehicle has been altered to hide false compartments.
...
- [x] The vehicle is not registered to the driver, and the driver does not know who owns it
- [ ] The vehicle has a current, valid inspection sticker
- [ ] The vehicle was purchased with a loan rather than cash
- [ ] The vehicle is registered to the driver's own name and address

**Explanation:** BPOC 15.14 lists vehicle ownership mismatched to the driver — especially when the driver can't identify the actual owner — as a load-car indicator.
...
- [ ] Stopping at every rest area along the route
- [ ] Driving during typical daytime commuting hours only
- [x] Exiting the roadway suddenly, attempting to hide, or committing traffic violations that suggest evasive or nervous driving
- [ ] Consistently obeying the speed limit and using turn signals properly

**Explanation:** BPOC 15.14 lists how the vehicle is operated — sudden exits, evasive maneuvers, and traffic violations — as behavioral indicators, alongside driver nervousness, fidgeting, and avoidance of eye contact.
...
Driver ______, fidgeting, and avoidance of eye contact are behavioral (as opposed to vehicle-based) load-car indicators discussed in BPOC 15.14.

**Explanation:** BPOC 15.14 separates vehicle-based indicators (false compartments, mismatched trim, registration mismatches) from driver behavioral indicators such as nervousness, fidgeting, and avoiding eye contact.
...
- [ ] The vehicle having a current inspection sticker
- [ ] The driver politely answering all questions
- [x] A pungent odor, a heavily-laden vehicle, or the absence of a key to open the trunk or glove box
- [ ] The stop occurring during business hours

**Explanation:** BPOC 15.15 lists nervousness, lack of/incorrect ID, lack of registration or insurance, unusual vehicle appearance, mismatched stories between occupants, a pungent odor, no key to the trunk/glove box, and a heavily-laden vehicle as probable-cause factors.
...
When multiple occupants give conflicting or ______ about their travel plans, origin, or destination when interviewed separately, this is a recognized probable-cause factor under BPOC 15.15.

**Explanation:** BPOC 15.15 lists mismatched stories between vehicle occupants (when interviewed separately) as a probable-cause indicator.
...
- [ ] Traveling with a large amount of properly packed luggage in the trunk
- [x] Extended travel with minimal luggage, or luggage placed on the back seat rather than the trunk
- [ ] Using a credit card to pay for fuel
- [ ] Traveling with immediate family members

**Explanation:** BPOC 15.15 lists extended-trip travel with minimal luggage, luggage on the back seat, empty suitcases, nervousness, and attempts to separate oneself from the vehicle as smuggler-profile characteristics.
...
- [ ] Only convicted felons, making the profile always reliable
- [ ] No one else — the profile is described as scientifically infallible
- [x] Undercover officers or others with legitimate reasons for similar behavior, so these factors should not be relied on in isolation

**Explanation:** The instructor note flags that undercover officers can exhibit similar nervous or evasive behaviors, cautioning against relying on any single factor alone to establish probable cause.
...
- [ ] Interview all occupants together so their answers can be compared in real time
- [ ] Avoid asking about travel plans, focusing only on license and registration
- [x] Separate the occupants and independently ask each about identity, origin, destination, and purpose of travel
- [ ] Allow the occupants to designate one spokesperson to answer for the group

**Explanation:** BPOC 15.15 recommends separating occupants and asking each independently about identity and travel details (origin, destination, purpose) to surface inconsistencies.
...
- [x] Proof of insurance, proof of ownership, or a rental agreement
- [ ] The occupants' passports, even for a routine in-state stop
- [ ] The occupants' Social Security cards
- [ ] The occupants' voter registration cards

**Explanation:** BPOC 15.15 lists asking for registration, insurance, ownership documentation, or a rental agreement as part of the recommended interview technique.
...
- [ ] Inside a hollowed-out ceiling tile
- [x] Inside clothing, body cavities, belts, shoes/socks, hats, or taped to the body
- [ ] Inside a vehicle's headliner
- [ ] Inside a toilet tank

**Explanation:** BPOC 15.16 groups on-the-person concealment separately from concealment in places (buildings) and in vehicles; clothing, body cavities, belts, shoes/socks, hats, jewelry, bags, hair, under the arms, and taped-to-body locations fall in the on-the-person category.
...
A common in-building concealment location listed in BPOC 15.16 is the ______, along with closets, refrigerators/freezers, cabinets, under/inside sinks, waste baskets, food canisters, and ceiling/floor/wall compartments.

**Explanation:** BPOC 15.16 lists the toilet tank among common household concealment locations.
...
- [ ] Inside a waste basket
- [ ] Inside a refrigerator or freezer
- [ ] Inside a closet
- [x] Inside the gas tank, hub caps, headliner, or A/C ducts

**Explanation:** BPOC 15.16's vehicle-concealment list includes the glove box, under/inside the dash, under the carpet, gas tank, hub caps, headliner, A/C ducts, trunk, console/cupholders, door panels, spare tire, and engine compartment.
...
- [x] On the person, in places (buildings), and in vehicles

**Explanation:** BPOC 15.16's three categories are: on the person, in places, and in vehicles.
...
Among vehicle concealment locations, BPOC 15.16 specifically lists the ______ as a common hiding spot, along with the trunk, console/cupholders, door panels, and engine compartment.

**Explanation:** BPOC 15.16 lists the spare tire compartment as a recognized vehicle concealment location.
...
- [ ] Items hidden inside a ceiling tile
- [x] Items taped directly to the body or hidden under the arms
- [ ] Items hidden inside a kitchen cabinet
- [ ] Items hidden inside a vehicle's spare tire

**Explanation:** BPOC 15.16 lists taping items to the body and concealment under the arms among on-the-person methods, alongside clothing, body cavities, belts, shoes/socks, hats, jewelry, bags, and hair.
...
"A conviction under this chapter may be obtained on the ______ ______ of a party to the offense." — HSC 483.072, permitting a Chapter 483 (Dangerous Drug Act) conviction without independent corroboration of a co-participant's testimony.

**Explanation:** HSC 483.072 permits conviction on the uncorroborated testimony of a party to the offense — a notable exception to the general accomplice-corroboration rule under CCP 38.14.
...
- [x] On the uncorroborated testimony of a party to the offense
- [ ] Only with corroborating physical evidence in every case
- [ ] Only with a signed confession from the defendant
- [ ] Only if two or more independent witnesses testify

**Explanation:** HSC 483.072's text is a single sentence: a Chapter 483 conviction may be obtained on the uncorroborated testimony of a party to the offense.
...
Under CCP Art. 38.14, a conviction generally cannot be had upon the testimony of an ______ unless corroborated by other evidence tending to connect the defendant with the offense committed, and the corroboration is not sufficient if it merely shows the commission of the offense.

**Explanation:** CCP Art. 38.14 is the general accomplice-testimony corroboration rule — contrast this with HSC 483.072's specific carve-out allowing uncorroborated party testimony for Chapter 483 dangerous-drug offenses.
...
- [ ] Corroborated only if the accomplice is a minor
- [x] Corroborated by other evidence tending to connect the defendant to the offense — corroboration that merely shows the offense occurred is not enough
- [ ] Given under oath, with no corroboration required at all
- [ ] Excluded entirely and never admissible

**Explanation:** Art. 38.14 sets the general rule requiring corroboration connecting the defendant to the offense, distinguishing this chapter's uncorroborated-testimony exceptions (HSC 483.072, CCP 38.141) as the exception rather than the rule.
...
Under CCP Art. 38.141, a defendant may not be convicted of certain offenses under HSC Chapter 481 on the testimony of a person who is a(n) ______ ______ ______ ______ ______ unless the testimony is corroborated by other evidence tending to connect the defendant with the offense — subject to specified exceptions.

**Explanation:** CCP Art. 38.141 applies the accomplice-style corroboration requirement specifically to undercover peace officer or special investigator testimony in HSC Chapter 481 prosecutions, subject to statutory exceptions.
...
- [ ] The arresting patrol officer who conducted the traffic stop
- [x] An undercover peace officer or special investigator
- [ ] A crime lab analyst who tested the substance
- [ ] The defendant's own family members

**Explanation:** CCP Art. 38.141 requires corroboration of an undercover peace officer's or special investigator's testimony before a defendant may be convicted of certain HSC Chapter 481 offenses, subject to specified statutory exceptions.
...
- [ ] CCP 38.141 applies only to civil cases, not criminal prosecutions
- [ ] All three provisions require corroboration with no exceptions
- [ ] All three provisions permit uncorroborated testimony with no restrictions
- [x] HSC 483.072 permits uncorroborated party testimony for dangerous-drug offenses, while CCP 38.14 and 38.141 generally require corroboration for accomplice and undercover-officer testimony, respectively
